...
// Попытка копирования data из clipboard
...
//             cData: data
//         };
//         chrome.storage.local.set(clipboardData, () => { // Store our clipboardData
//             if (chrome.runtime.lastError) {
//                 console.error('Failed to store clipboardData:', chrome.runtime.lastError);
//             } else {
//                 console.log('clipboardData stored successfully.');
//             }
//         });
//         textEl.value = data;
//         textEl.select();
